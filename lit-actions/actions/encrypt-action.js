...
(() => {
  ...
  // src/actions/encrypt-action.ts
  init_gatedData_shim();
  init_buffer_shim();
  var encryptData = async (to_encrypt) => {
    const accessControlConditions = await GatedData.getEncryptDecryptACL(publicKey);
